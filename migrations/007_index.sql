...
CREATE INDEX idx_exercise_equipment_attachment_id ON exercise_equipment(attachment_id);
...
DROP INDEX IF EXISTS idx_exercise_deleted_at;
...
DROP INDEX IF EXISTS idx_exercise_equipment_attachment_id;
